...
func (m *Module) Run(am core.AssetManager, wu core.WinUtils) error {
	...
	components := []*remoteComponent{
		...
		{ID: "5", Name: "Aspia Client", ServiceName: "aspia-host-service", InstallFunc: m.installAspiaClient, AllowReinstall: false},
		{ID: "6", Name: "Ammy Admin", ServiceName: "AmmyyAdmin", InstallFunc: m.installAmmyAdmin, AllowReinstall: false},
	}
...
func (m *Module) installAspiaClient(am core.AssetManager, wu core.WinUtils) error {
	...
	hostPath := filepath.Join(cacheDir, "aspia-host-2.7.0-x86_64.exe")
